...
/// <reference path="./adsevents.d.ts" />
/// <reference path="./bannerads.d.ts" />
/// <reference path="./fullscreenads.d.ts" />
...
interface CASMobileAds {
  ...
  /**
   * Singleton Banner ad instance used throughout the application.
   */
  bannerAd: BannerAd;
  /**
   * Singleton Medium Rectangle banner ad instance used throughout the application.
   */
  mrecAd: MRecAd;
  /**
   * Singleton AppOpen ad instance used throughout the application.
   */
  appOpenAd: AppOpenAd;
  /**
   * Singleton Interstitial ad instance used throughout the application.
   */
  interstitialAd: InterstitialAd;
  /**
   * Singleton Rewarded ad instance used throughout the application.
   */
